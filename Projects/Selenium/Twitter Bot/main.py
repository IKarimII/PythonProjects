...
start_speed = driver.find_element(By.XPATH, '//*[@id="container"]/div/div[3]/div/div/div/div[2]/div[3]/div[1]/a')
start_speed.click()
...
while not ended:
    ...
    ping = driver.find_element(By.XPATH, '//*[@id="container"]/div/div[3]/div/div/div/div[2]/div[3]/div[3]/div/div[3]/div/div/div[2]/div[2]/div/span[2]/span')
    if down.text != '—' and up.text != '' and up.text != '—' and ping.text != '—':
        ended =True

print(f"down:{down.text}, up:{up.text}, ping:{ping.text}")
